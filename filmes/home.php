...
<html lang="pt-BR">
   <head>
      ...
      <!-- site metas -->
      <title>Home - Nosso Planeta, Nossa Casa</title>
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="480" src="https://www.youtube.com/embed/oU0qlQ5a8YA" title="DOCUMENTÁRIO - Home, Nosso Planeta, Nossa Casa (Completo - Pt_Br) HD" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">Home - Nosso Planeta, Nossa Casa</h1>

                  <p class="long_text">5 de junho de 2009</p>
                  ...
                  <div>
                     <div class="w-auto px-5">
                        <div class="row">
                           ...
                           <!-- #96861E -->
                           <h2><img src="../assets/images/estrela-icon.png" alt="ícone de estrela" width="20" height="20"> Avaliação: 8.5 no IMDB</h2>
                           <h2><img src="../assets/images/genero-icon.png" alt="ícone de lista" width="20" height="20"> Gênero: Documentário</h2>
                        </div>
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 1h58m</h2>
      ...
      <script>
         $('#datepicker').datepicker({
             uiLibrary: 'bootstrap4'
                  ...
                  <p class="long_text">Numa viagem para descobrir a cura contra a maldição de Tatarigami, Ashitaka, se encontra uma guerra entre os deuses da foresta e Tatara, uma colônia mineira.</p>
                  <div>
                     <div class="w-auto px-5">
                        <div class="row">
                           <div class="col-md-6 col-sm-4">
                           ...
                           <h2><img src="../assets/images/genero-icon.png" alt="ícone de lista" width="20" height="20"> Gênero: Animação, Ação</h2>
                        </div>
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 2h14m</h2>
