         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="480" src="https://www.youtube.com/embed/ggTV3afKXl4" title="Extraordinário - Filme completo dublado" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">Extraordinário</h1>

                  <p class="long_text">7 de dezembro de 2017</p>
                  
                  <p class="long_text">Conta a inspiradora é doce historia de August Pullman, um menino com diferenças na sua cara que vai na escola pela primeira vez.</p>
                  <div>
                     <div class="w-auto px-2">
                        <div class="row">
                           <div class="col-md-6 col-sm-4">
                           <!-- #96861E -->
                           <h2><img src="../assets/images/estrela-icon.png" alt="ícone de estrela" width="20" height="20"> Avaliação: 7.9 no IMDB</h2>
                           <h2><img src="../assets/images/genero-icon.png" alt="ícone de lista" width="20" height="20"> Gênero: Drama, Família</h2>
                        </div>
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 1h53m</h2>
