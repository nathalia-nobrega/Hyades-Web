...
<html lang="pt-BR">
   <head>
      ...
      <!-- site metas -->
      <title>Selma: Uma Luta Pela Igualdade</title>
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="480" src="https://www.youtube.com/embed/EwvxtJwbRgM" title="Selma - Uma luta pela igualdade Trailer Oficial Legendado (2015) - David Oyelowo HD" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">Selma: Uma Luta Pela Igualdade</h1>

                  <p class="long_text">5 de fevereiro de 2015</p>
                  
                  <p class="long_text">Uma crônica da campanha do Dr. Martin Luther King Jr. para adquirir o direito de voto durante a marcha desde Selma até Montgomery em Alabama, em 1965.</p>
                  <div>
                     <div class="w-auto px-2">
                        ...
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 2h8m</h2>
