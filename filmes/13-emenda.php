         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="480" src="https://www.youtube.com/embed/z7iB1v7PUiA" title="A 13ª Emenda | Trailer Oficial legendado [HD]" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">A 13ª Emenda</h1>

                  <p class="long_text">19 de março de 2015</p>
                  
                  <p class="long_text">Uma análise aprofundada do sistema prisional nos Estados Unidos e como ele revela a história da nação de desigualdade racial.</p>
                  <div>
                     <div class="w-auto px-2">
                        ...
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 1h40m</h2>
