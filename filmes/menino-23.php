...
<html lang="pt-BR">
   <head>
      ...
      <!-- site metas -->
      <title>Menino 23: Infâncias Perdidas no Brasil</title>
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="480" src="https://www.youtube.com/embed/4wmraawmw38" title="Menino 23 - Infâncas Perdidas no Brasil (Trailer)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">Menino 23: Infâncias Perdidas no Brasil</h1>

                  <p class="long_text">7 de julho de 2016</p>
                  
                  <p class="long_text">Menino 23 é um documentário que retrata a investigação do historiador Sidney Aguilar, após descobrir que em uma fazenda, no interior de São Paulo, havia tijolos com a suástica encravada, os quais não eram muito antigos e, por isso, evidenciavam a existência de um local explícitamente nazista em um período recente da história do Brasil.</p>
                  <div>
                     <div class="w-auto px-2">
                        ...
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 1h20m</h2>
                           <h2><img src="../assets/images/classificacao-icon.png" alt="ícone de classificação" width="24" height="24"> Classificação: 10</h2>
                           </div>
                        </div>
