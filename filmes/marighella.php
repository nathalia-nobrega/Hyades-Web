         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="480" src="https://www.youtube.com/embed/fd8oX1u8gRA" title="Marighella | Trailer Oficial" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">Marighella</h1>

                  <p class="long_text">4 de novembro de 2021</p>
                  
                  <p class="long_text">Um filme biográfico sobre Carlos Marighella, escritor marxista brasileiro, político e guerrilheiro que viveu no século 20 e foi morto pela ditadura militar brasileira em 1969.</p>
                  <div>
                     <div class="w-auto px-2">
                        <div class="row">
                           <div class="col-md-6 col-sm-4">
                           <!-- #96861E -->
                           <h2><img src="../assets/images/estrela-icon.png" alt="ícone de estrela" width="20" height="20"> Avaliação: 6.6 no IMDB</h2>
                           <h2><img src="../assets/images/genero-icon.png" alt="ícone de lista" width="20" height="20"> Gênero: Drama, História</h2>
                        </div>
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 2h35m</h2>
