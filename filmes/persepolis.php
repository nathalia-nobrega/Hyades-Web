         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="506" src="https://www.youtube.com/embed/CnXsamZ0H38" title="Persépolis_filme completo e dublado" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">Persépolis</h1>

                  <p class="long_text">23 de fevereiro de 2008</p>
                  
                  <p class="long_text">Uma menina iraniana precoce e franca cresce durante a Revolução Islâmica.</p>
                  <div>
                     <div class="w-auto px-2">
                        <div class="row">
                           ...
                           <h2><img src="../assets/images/genero-icon.png" alt="ícone de lista" width="20" height="20"> Gênero: Animação, Biografia</h2>
                        </div>
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 1h36m</h2>
