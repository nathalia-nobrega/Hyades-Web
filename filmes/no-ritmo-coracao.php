         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="480" src="https://www.youtube.com/embed/vVU2ixNLOt8" title="No Ritmo do Coração | Trailer Oficial | Amazon Prime Video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">No Ritmo do Coração</h1>

                  <p class="long_text">13 de agosto de 2021</p>
                  
                  <p class="long_text">Ruby é a única pessoa ouvinte em sua família surda. Quando o negócio de pesca da família é ameaçado, Ruby fica dividida entre o amor pela música e o medo de abandonar seus pais.</p>
                  <div>
                     <div class="w-auto px-2">
                        ...
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 1h51m</h2>
