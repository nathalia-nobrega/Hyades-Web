         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="529" src="https://www.youtube.com/embed/rEN_1_FX74c" title="Nunca, Raramente, Às Vezes, Sempre | Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">Nunca, Raramente, Às Vezes, Sempre</h1>

                  <p class="long_text">19 de novembro de 2020</p>
                  
                  <p class="long_text">Dois adolescentes na zona rural da Pensilvânia viajam para Nova York para procurar ajuda médica após uma gravidez indesejada.</p>
                  <div>
                     <div class="w-auto px-2">
                        ...
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 1h41m</h2>
