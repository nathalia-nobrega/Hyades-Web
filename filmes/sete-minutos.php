...
<html lang="pt-BR">
   <head>
      ...
      <!-- site metas -->
      <title>Sete Minutos Depois da Meia-Noite</title>
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="480" src="https://www.youtube.com/embed/JhW22S4Ev9o" title="Sete Minutos Depois da Meia Noite - Trailer 2" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">Sete Minutos Depois da Meia-Noite</h1>

                  <p class="long_text">5 de janeiro de 2017</p>
                  
                  <p class="long_text">Um menino procura a ajuda de três monstros para sobreviver a doença da sua mãe solteira.</p>
                  <div>
                     <div class="w-auto px-2">
                        <div class="row">
                           <div class="col-md-6 col-sm-4">
                           <!-- #96861E -->
                           <h2><img src="../assets/images/estrela-icon.png" alt="ícone de estrela" width="20" height="20"> Avaliação: 7.4 no IMDB</h2>
                           <h2><img src="../assets/images/genero-icon.png" alt="ícone de lista" width="20" height="20"> Gênero: Drama, Aventura</h2>
                        </div>
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 1h48m</h2>
