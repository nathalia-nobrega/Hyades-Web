         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-7 col-md-4">
                  <iframe width="100%" height="529" src="https://www.youtube.com/embed/7nc1GE_hnLs" title="Adoráveis Mulheres | Trailer Legendado | 09 de janeiro nos cinemas" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
               <div class="col-md-5 col-md-4">
                  <h1 class="arrival_text">Adoráveis Mulheres</h1>

                  <p class="long_text">9 de janeiro de 2020</p>
                  
                  <p class="long_text">Quatro irmãs que vão completar 18 anos depois da guerra civil dos Estados Unidos.</p>
                  <div>
                     <div class="w-auto px-2">
                        <div class="row">
                           <div class="col-md-6 col-sm-4">
                           <!-- #96861E -->
                           <h2><img src="../assets/images/estrela-icon.png" alt="ícone de estrela" width="20" height="20"> Avaliação: 7.8 no IMDB</h2>
                           <h2><img src="../assets/images/genero-icon.png" alt="ícone de lista" width="20" height="20"> Gênero: Drama, Romance</h2>
                        </div>
                        <div class="col-md-6 col-sm-4">
                           <h2><img src="../assets/images/duracao-icon.png" alt="ícone de relógio" width="20" height="20"> Duração: 2h15m</h2>
